<template>
<section class="py-8 lg:py-18 bg-[#efefef] scroll-mt-[50px] lg:scroll-mt-[80px]" id="team">
				...
				<div class="text-left lg:text-center">
					<p class="font-bold my-2 lg:my-4">
						...
						<a v-if="row.website_url" :href="row.website_url" target="_blank" class="ms-1">
							<span class="text-gray-600 align-top material-symbols-outlined">public</span>
						</a>
					</p>
