...
<section class="py-8 lg:py-18 scroll-mt-[50px] lg:scroll-mt-[80px]" id="contact"><div class="w-5/6 lg:w-3/4 mx-auto text-center">
	...
	<div class="lg:w-2/3 mx-auto text-left">
		...
		<div class="text-center lg:float-right">
			<button @click="submit()" type="button" class="text-white bg-primary border-1 hover:border-primary hover:bg-white hover:text-primary dark:border-transparent dark:hover:bg-[#222831] rounded-lg text-sm px-3 lg:px-5 py-1.5 lg:py-2.5">{{ $t('form.submit') }}</button>
		</div>
	</div>
</div></section>
</template>